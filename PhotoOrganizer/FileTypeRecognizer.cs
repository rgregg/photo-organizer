    ...
    public class FileTypeRecognizer
    {
        ...
        private static List<FormatMagicData> Formats = new List<FormatMagicData>()
        {
            new FormatMagicData(MediaType.Image, FileBinaryFormat.Jpeg, ".jpg", 
                new ByteRangeMatch(0xFF, 0xD8, 0xFF, 0xE0, null, null, 0x4A, 0x46, 0x49, 0x46, 0x00),
                new ByteRangeMatch(0xFF, 0xD8, 0xFF, 0xDB),
                new ByteRangeMatch( 0xFF, 0xD8, 0xFF, 0xE1, null, null, 0x45, 0x78, 0x69, 0x66, 0x00 ),
                new ByteRangeMatch(0xFF, 0xD8, 0xFF, 0xEE)),
            ...
            new FormatMagicData(MediaType.Image, FileBinaryFormat.Heic, ".heic", 
                new ByteRangeMatch( null, null, null, null, 0x66, 0x74, 0x79, 0x70, 0x68, 0x65, 0x69, 0x63, 0x00 )),
            new FormatMagicData(MediaType.Video, FileBinaryFormat.QuickTime, ".mov",
                new ByteRangeMatch(null, null, null, null, 0x66, 0x74, 0x79, 0x70, 0x71, 0x74, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00, 0x71, 0x74, 0x20, 0x20)),
            ...
            new FormatMagicData(MediaType.Video, FileBinaryFormat.Avi, ".avi", 
                new ByteRangeMatch(0x52, 0x49, 0x46, 0x46, null, null, null, null, 0x41, 0x56, 0x49, 0x20)),
            ...
            new FormatMagicData(MediaType.Image, FileBinaryFormat.Dng, ".dng",
                new ByteRangeMatch(0x49, 0x49, 0x2A, 0x00, 0x08, 0x00, 0x00, 0x00, null, 0x00, 0xfe, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00),
